...
app = Flask(__name__)
DATABASE1 = 'ExpenseDB_3'
DATABASE2 = 'ExpenseDB_4'
PASSWORD = 'password'
USER = 'root'
...
databases = {
    'db3': 'mysql://root:password@mysqlserver:3306/ExpenseDB_3',
    'db4': 'mysql://root:password@mysqlserver:3306/ExpenseDB_4'
}
...
#---------------------------------------DB1---------------------------------------------------------------------
class expense_3(db.Model):

	__tablename__ = 'expense3'
    	__bind_key__ = 'db3'
...
#---------------------------------------DB2-----------------------------------------------------
class expense_4(db.Model):

	__tablename__ = 'expense4'
    	__bind_key__ = 'db4'

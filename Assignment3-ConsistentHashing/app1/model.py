...
app = Flask(__name__)
DATABASE1 = 'ExpenseDB_1'
DATABASE2 = 'ExpenseDB_2'
PASSWORD = 'password'
USER = 'root'
...
databases = {
    'db1': 'mysql://root:password@mysqlserver:3306/ExpenseDB_1',
    'db2': 'mysql://root:password@mysqlserver:3306/ExpenseDB_2'
}
...
#---------------------------------------DB1---------------------------------------------------------------------
class expense_1(db.Model):

	__tablename__ = 'expense1'
    	__bind_key__ = 'db1'
...
#---------------------------------------DB2-----------------------------------------------------
class expense_2(db.Model):

	__tablename__ = 'expense2'
    	__bind_key__ = 'db2'
